  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeIsDefault(address, addressInfo)">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{ userAddressDefault.userAddress }}</span>
...
import {mapState} from "vuex"
  export default {
   ...
   async mounted() {
    ...
    computed:{
      ...mapState({addressInfo:state=>state.trade.userAddressInfo,
    ...
    methods: {
     ...
     async submitOrder(){
       ...
       let data = {
         ...
         deliveryAddress: this.userAddressDefault.userAddress,
         paymentWay: "ONLINE",
